...
import edu.harvard.hms.dbmi.avillach.hpds.processing.patient.PatientIDFilter;
...
public class AbstractProcessor {
    ...
    @Nullable
    private final PatientIDFilter patientIDFilter;
    ...
    public AbstractProcessor(
        ...
        @Autowired(required = false) PatientIDFilter patientIDFilter
    ...
    public AbstractProcessor(
        ...
        String hpdsDataDirectory, @Autowired(required = false) PatientIDFilter patientIDFilter
    ) {
        this.phenotypeMetaStore = phenotypeMetaStore;
        this.store = store;
        this.genomicProcessor = genomicProcessor;
    ...
    public Set<Integer> getPatientSubsetForQuery(Query query) {
        ...
        if (patientIdSet == null) {
            patientIdSet = phenotypeMetaStore.getPatientIds();
        }
        return patientIDFilter == null ? patientIdSet : patientIDFilter.applyPatientFilter(query, patientIdSet);
    }
